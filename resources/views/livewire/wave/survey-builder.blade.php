                ...
                <div class="mt-8">
                    ...
                    <div class="mt-4 flex items-center">
                        ...
                        <label class="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" wire:model.lazy="isActive" class="sr-only peer">
                    ...
                    <div class="mt-4" x-show="!$wire.isActive">
                        <label for="inactiveMessage" class="block text-sm font-medium text-gray-700">Message for Inactive Survey</label>
                        <textarea id="inactiveMessage" wire:model.lazy="inactiveMessage" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" placeholder="This survey is currently inactive."></textarea>
                    </div>
                </div>
